...
<html><head><title>Bercy Scroll Pay</title>
<style>
...
<h1>🔺 Bercy Scroll Pay</h1>
<p>World's first <b>x402 + AC2</b> cross-border payment layer on Scroll Mainnet.</p>
<div>
...
app.get("/api/health", async (req, res) => {
  try {
    ...
    res.json({ status: "ok", service: "Bercy Scroll Pay", network: "Scroll Mainnet", protocols: ["x402", "AC2"], totalCorridors: 95 });
  }
});
...
app.listen(PORT, () => console.log("Bercy Scroll Pay running on port " + PORT));
